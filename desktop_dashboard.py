...
st.markdown("Upload a screenshot of your monitor, and ask the Claw to find UI components, text, or tasks!")
...
if uploaded_file is not None:
    ...
    with col1:
        st.image(image, caption="Current Workspace", use_column_width=True)

    with col2:
        st.markdown("### Command the Claw")
        query = st.text_input("What should I locate?", placeholder="e.g., 'the submit button', 'vscode terminal'")
